...
int main() {
    ...
    sf::Font font;
    if (!font.loadFromFile("assets/fonts/ARLRDBD.TTF"))
    ...
    t1.loadFromFile("assets/images/spritesheetSpaceship.png");
    t2.loadFromFile("assets/images/background.jpg");
    t3.loadFromFile("assets/images/explosions/type_C.png");
    ...
    t7.loadFromFile("assets/images/explosions/type_B.png");
    t8.loadFromFile("assets/images/Shield.png");
    t9.loadFromFile("assets/images/explosions/type_A.png");
